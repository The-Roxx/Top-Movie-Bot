...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002218635627')
...
DATABASE_NAME = environ.get('DATABASE_NAME', "RoxStar")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'I_PapCornBeta') # Support Chat Link Without https:// or @
